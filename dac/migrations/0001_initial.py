# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-03-19 19:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dac.Beer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('slug', models.SlugField(unique=True)),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='dac.UserProfile')),
        ...
        migrations.AddField(
            model_name='review',
            name='submitter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dac.UserProfile'),
        ),
        migrations.AddField(
            model_name='beer',
            name='flavors',
